...
4. ตรวจสอบข้อมูลให้ถูกต้องแล้วกดปุ่ม Confirm ระบบจะพาไปที่หน้า Project แสดงให้เห็นสมาชิกที่เพิ่มขึ้นมา 2 คน โดย Email ที่ถูกเพิ่มมาใน Project แล้วจะมี Status เป็น Active ส่วน Email ที่ยังไม่ถูกเพิ่มมาจะมี Status เป็น Pending แต่เมื่อ Email นี้สมัครเข้ามาแล้วสถานะจะเปลี่ยนไปเป็น Pending Invite
