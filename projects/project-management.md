...
* **Owner** คือ เจ้าของและผู้ที่สร้าง Project มีสิทธิ์ในการเข้าถึง Resource ทุกอย่างของ Project สามารถจัดการการชำระเงินของ Project ผ่าน Billing Page รวมถึงมีสิทธิ์ในการจัดการ Project และ สมาชิกของ Project ได้
* **Billing** คือ สมาชิกที่สามารถจัดการการชำระเงินของโปรเจค ผ่าน Billing Page ได้
...
4. [Request Change Project Type](project-management.md#request-change-project-type)
...
3. ตรวจสอบข้อมูลที่ใส่ให้ถูกต้อง แล้วกดปุ่ม “Create project” หลังจากนั้น ระบบจะพาไปที่หน้า Project พร้อมเลือก Project ที่สร้างเสร็จแล้วให้ทันที เพื่อใช้งานอื่น ๆ ต่อไป
...
2. ที่หน้า “Add user” ให้ใส่ข้อมูลดังต่อไปนี้
...
3. ตรวจสอบข้อมูลที่ใส่ให้ถูกต้อง แล้วกดปุ่ม “Next” หลังจากนั้น ระบบจะพาไปที่หน้าสรุป ที่จะบอกว่ามี email ใดบ้างที่มีในระบบและจะถูกเพิ่มเข้ามาใน Project ทันที และ email ใดบ้างที่ไม่มีในระบบ และจะถูกส่ง email ชวนสมัครสมาชิกไป
...
4. ตรวจสอบข้อมูลให้ถูกต้องแล้วกดปุ่ม Confirm ระบบจะพาไปที่ page Project แสดงให้เห็นสมาชิกที่เพิ่มขึ้นมา 2 คน โดย email ที่ถูกเพิ่มมาใน Project แล้วจะมี status เป็น active ส่วน email ที่ยังไม่ถูกเพิ่มมาจะมี status เป็น pending แต่เมื่อ email นี้สมัครเข้ามาแล้วสถานะจะเปลี่ยนไปเป็น pending invite
...
5. เมื่อ status ของสมาชิกกลายเป็น **Pending invite** ให้กดที่ปุ่ม more แล้วเลือก Confirm Invite เพื่อเพิ่มเข้าเป็นสมาชิก Project ทันที
...
3. ตรวจสอบข้อมูลที่เลือกให้ถูกต้อง แล้วกดปุ่ม Confirm หลังจากนั้น ระบบจะพาไปที่ page Project พร้อมแสดงสิทธิ์ที่เปลี่ยนไป
...
3. หลังจากนั้น ระบบจะพาไปที่ page Project พร้อมแสดงสมาชิกที่เปลี่ยนไป
...
2. แก้ไขเบอร์โทรศัพท์ หรือ เพิ่ม-ลด Email ได้ดังต่อไปนี้
...
3. ตรวจสอบข้อมูลที่ใส่ให้ถูกต้อง แล้วกดปุ่ม Confirm หลังจากนั้น ระบบจะพาไปที่หน้า Project พร้อมแสดงข้อมูลที่เปลี่ยนไป
...
3. ตรวจสอบข้อมูลให้ครบถ้วนถูกต้องแล้วกด Confirm ระบบจะพากลับไปที่ page Project จะเห็นว่าที่ Project type จะมี
...
2. ที่หน้า “Request for change billing type” ให้ใส่ข้อมูลดังต่อไปนี้

* **Contact name:** ใส่ชื่อที่ใช้ในการติดต่อกับทีมงานของ NCP
* **Type:** ชนิดของการคิดเงิน โดยปัจจุบันจะมีให้เลือกเพียง Postpai**d**
...
3. ตรวจสอบข้อมูลให้ครบถ้วนถูกต้องแล้วกด Confirm ระบบจะพากลับไปที่ page Project จะเห็นว่าที่ Billing type จะมีสัญลักษณ์ ![](https://lh6.googleusercontent.com/E-Jm9zYIaw6-0JqrF0smn8-FndUiHRnPuT9ay9HvVHKJ1RJtUgobS3v1yuRJHAAJl-mie_AByNkR662Q6DGqShkmKWNLTsA5tlJU8ayRFy4FtUxacNiOc-ljcYRgduxPf64PgQs)อยู่ ซึ่งหมายถึงคำขอของคุณกำลังรอการพิจารณาอยู่ และจะเปลี่ยนเป็น ![](https://lh5.googleusercontent.com/qZ9MuVbEFROtfS8sT67ffVoPFommvNtXm5SS_48mmR3ljs-sXg2_O__6lE0w4FlpVUftLMLp1sJxuJT22uFQ6VIpqG46BUquNCvkl-Ygtve7LHbNhcZl3V2nA1_zckhcmEFw7FY)เมื่อได้รับการอนุมัติ
...
3. ระบบจะพามาที่หน้า Restored Project ที่จะมีเวลาบอก ว่า Project จะถูกลบถาวรภายในวันไหน
