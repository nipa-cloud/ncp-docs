...
1. ที่หน้า Create project _\*\*_ให้ใส่ข้อมูลดังต่อไปนี้
2. **Project name**: ชื่อ Project ที่จะแสดงที่ Dropdown และ page Project
3. **Contact phone number**: เบอร์โทรศัพท์ที่ Admin ของเราจะใช้ในการติดต่อเมื่อเกิดปัญหากับ Project ของคุณ โดยจะมีเบอร์โทรศัพท์ของ User ปัจจุบัน เป็นค่าพื้นฐาน
4. **Contact email\(s\):** \(maximum email input limit 10\) email ที่ใช้ในการแจ้งข่าวสารต่างๆ โดยจะมี email ของสมาชิก Project เป็นค่าพื้นฐาน และสามารถเพิ่ม email อื่นๆได้อีกไม่เกิน 10 email
...
1. ตรวจสอบข้อมูลที่ใส่ให้ถูกต้อง แล้วกดปุ่ม **“Create project”** หลังจากนั้น ระบบจะพาไปที่หน้า Project พร้อมเลือก Project ที่สร้างเสร็จแล้วให้ทันที เพื่อใช้งานอื่น ๆ ต่อไป
...
1. ที่หน้า **“Add user”** ให้ใส่ข้อมูลดังต่อไปนี้
2. **Email\(s\):** ใส่ email ของ User ที่ต้องการเพิ่มเข้ามาใน Project โดยสามารถใส่ได้ทั้ง email ของ User ที่มีในระบบ NCP และไม่ได้อยู่ในระบบ NCP ด้วย
3. **Role:** เลือกประเภทของสมาชิกที่ต้องการเพิ่มใน Project
...
1. ตรวจสอบข้อมูลที่ใส่ให้ถูกต้อง แล้วกดปุ่ม “Next” หลังจากนั้น ระบบจะพาไปที่หน้าสรุป ที่จะบอกว่ามี email ใดบ้างที่มีในระบบและจะถูกเพิ่มเข้ามาใน Project ทันที และ email ใดบ้างที่ไม่มีในระบบ และจะถูกส่ง email ชวนสมัครสมาชิกไป
...
1. ตรวจสอบข้อมูลให้ถูกต้องแล้วกดปุ่ม Confirm ระบบจะพาไปที่ page Project แสดงให้เห็นสมาชิกที่เพิ่มขึ้นมา 2 คน โดย email ที่ถูกเพิ่มมาใน Project แล้วจะมี status เป็น active ส่วน email ที่ยังไม่ถูกเพิ่มมาจะมี status เป็น pending แต่เมื่อ email นี้สมัครเข้ามาแล้วสถานะจะเปลี่ยนไปเป็น pending invite
...
1. เมื่อ status ของสมาชิกกลายเป็น **Pending invite** ให้กดที่ปุ่ม more แล้วเลือก **Confirm Invite** เพื่อเพิ่มเข้าเป็นสมาชิก Project ทันที
...
1. เลือกประเภทที่ต้องการ โดยจะเลือกได้แค่ **Biller** และ **Member** ไม่สามารถให้สิทธิ์ Owner กับสมาชิกคนอื่นได้
...
1. ตรวจสอบข้อมูลที่เลือกให้ถูกต้อง แล้วกดปุ่ม Confirm หลังจากนั้น ระบบจะพาไปที่ page Project พร้อมแสดงสิทธิ์ที่เปลี่ยนไป
...
1. หน้าต่าง Confirm จะแสดงขึ้นมา ให้กด Confirm
...
1. หลังจากนั้น ระบบจะพาไปที่หน้า Project พร้อมแสดงสมาชิกที่เปลี่ยนไป
...
1. ที่หน้า Project กดปุ่ม ![](https://lh4.googleusercontent.com/BGDpH1xsHB8jagbpYjHNDLcA-zRKNmFIcN0gJUylm0e9cYQSbPsLqWHDvdmkh6BQOeA5NP0zKJ2bQCEwWsnhZIsME9JPiw04KPs9zzZFtumkRlqirfqt_IJS0x_NXNvXSJ49mdQ) _\*\*_
...
1. แก้ไขเบอร์โทรศัพท์ หรือ เพิ่ม-ลด Email ได้ดังต่อไปนี้
2. **Phone number:** เบอร์โทรศัพท์ที่ Admin ของเราจะใช้ในการติดต่อเมื่อเกิดปัญหากับ Project ของคุณ
3. **Contact email\(s\):** \(maximum email input limit 10\) email ที่ใช้ในการแจ้งข่าวสารต่างๆ โดยจะมี email ของสมาชิก Project เป็นค่าพื้นฐาน และสามารถเพิ่ม email อื่นๆได้อีกไม่เกิน 10 email 
...
1. ตรวจสอบข้อมูลที่ใส่ให้ถูกต้อง แล้วกดปุ่ม Confirm หลังจากนั้น ระบบจะพาไปที่หน้า Project พร้อมแสดงข้อมูลที่เปลี่ยนไป
...
1. ที่หน้า **“Request for change project type”** ให้ใส่ข้อมูลดังต่อไปนี้
2. **Contact name:** ใส่ชื่อที่ใช้ในการติดต่อกับทีมงานของ NCP
3. **Tax ID:** เลขผู้เสียภาษีของบริษัทิ
4. **Name:** ชื่อของบริษัท
5. **Phone:** เบอร์โทรศัพท์ของบริษัท ที่สามารถติดต่อได้
6. **Address:** ที่อยู่ของบริษัท
7. **Attachment:** แนบเอกสารจดทะเบียนบริษัท
...
1. ตรวจสอบข้อมูลให้ครบถ้วนถูกต้องแล้วกด Confirm ระบบจะพากลับไปที่หน้า Project จะเห็นว่าที่ Project type จะมี
2. สัญลักษณ์ ![](https://lh6.googleusercontent.com/E-Jm9zYIaw6-0JqrF0smn8-FndUiHRnPuT9ay9HvVHKJ1RJtUgobS3v1yuRJHAAJl-mie_AByNkR662Q6DGqShkmKWNLTsA5tlJU8ayRFy4FtUxacNiOc-ljcYRgduxPf64PgQs)หมายถึงคำขอของคุณ กำลังรอการพิจารณาอยู่
3. สัญลักษณ์ ![](https://lh5.googleusercontent.com/qZ9MuVbEFROtfS8sT67ffVoPFommvNtXm5SS_48mmR3ljs-sXg2_O__6lE0w4FlpVUftLMLp1sJxuJT22uFQ6VIpqG46BUquNCvkl-Ygtve7LHbNhcZl3V2nA1_zckhcmEFw7FY)หมายถึงคำขอของคุณ ได้รับการอนุมัติ
...
1. ที่หน้า “**Request for change billing type**” ให้ใส่ข้อมูลดังต่อไปนี้
2. **Contact name:** ใส่ชื่อที่ใช้ในการติดต่อกับทีมงานของ NCP
3. **Type:** ชนิดของการคิดเงิน โดยปัจจุบันจะมีให้เลือกเพียง Postpai**d**
...
1. ตรวจสอบข้อมูลให้ครบถ้วนถูกต้องแล้วกด Confirm ระบบจะพากลับไปที่หน้า Project จะเห็นว่าที่ Billing type จะมีสัญลักษณ์ ![](https://lh6.googleusercontent.com/E-Jm9zYIaw6-0JqrF0smn8-FndUiHRnPuT9ay9HvVHKJ1RJtUgobS3v1yuRJHAAJl-mie_AByNkR662Q6DGqShkmKWNLTsA5tlJU8ayRFy4FtUxacNiOc-ljcYRgduxPf64PgQs)อยู่ ซึ่งหมายถึงคำขอของคุณกำลังรอการพิจารณาอยู่ และจะเปลี่ยนเป็น ![](https://lh5.googleusercontent.com/qZ9MuVbEFROtfS8sT67ffVoPFommvNtXm5SS_48mmR3ljs-sXg2_O__6lE0w4FlpVUftLMLp1sJxuJT22uFQ6VIpqG46BUquNCvkl-Ygtve7LHbNhcZl3V2nA1_zckhcmEFw7FY)เมื่อได้รับการอนุมัติ
...
1. หน้าต่าง Confirm จะแสดงข้อความบอกว่า หากลบ Project นี้ไปแล้ว จะไม่สามารถเข้าถึง resource ต่างๆได้ แต่จะยังสามารถกู้คืนได้ภายใน 7 วัน ถ้ายอมรับเงื่อนไข ให้กด Confirm
...
1. ระบบจะพามาที่หน้า **Restored Project** ที่จะมีเวลาบอก ว่า Project จะถูกลบถาวรภายในวันไหน
...
1. หากต้องการกู้ Project คืน ให้กดที่ปุ่ม ![](https://lh5.googleusercontent.com/yELXqK_Wbl6pv1AtjFKtSvCovnLRTip4Ug2x2psO0VHRULJ0783dwZB8Yfh8KUb1NPWXPKznEFsAYK9JHlqja9rxtGk4WtVZaGMDHCoWyTYB7K05t5gsq-TgBhJmuFjvi3H7PZQ)แล้วระบบจะพากลับไปที่หน้า Project และสามารถกลับไปใช้งานได้ทันที
