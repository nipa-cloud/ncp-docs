...
1. ที่หน้า **Create project** ให้ใส่ข้อมูลดังต่อไปนี้
...
1. ตรวจสอบข้อมูลให้ถูกต้องแล้วกดปุ่ม Confirm ระบบจะพาไปที่หน้า Project แสดงให้เห็นสมาชิกที่เพิ่มขึ้นมา 2 คน โดย Email ที่ถูกเพิ่มมาใน Project แล้วจะมี Status เป็น Active ส่วน Email ที่ยังไม่ถูกเพิ่มมาจะมี Status เป็น Pending แต่เมื่อ Email นี้สมัครเข้ามาแล้วสถานะจะเปลี่ยนไปเป็น Pending Invite
...
1. ตรวจสอบข้อมูลที่เลือกให้ถูกต้อง แล้วกดปุ่ม Confirm หลังจากนั้น ระบบจะพาไปที่หน้า Project พร้อมแสดงสิทธิ์ที่เปลี่ยนไป
...
3. **Tax ID:** เลขผู้เสียภาษีของบริษัท
...
2. **Contact name:** ใส่ชื่อที่ใช้ในการติดต่อกับทีมงานของ NCP
3. **Type:** ชนิดของการคิดเงิน โดยปัจจุบันจะมีให้เลือกเพียง Postpaid
...
1. ระบบจะพามาที่หน้า **Restored Project** ที่จะมีเวลาบอกว่า Project จะถูกลบถาวรภายในวันไหน
